...
# ---------------------------------------------------
WHICH_RUN=20240911-Norgen_Nano_16S_ITS # Including this to help remove human error, just changing this and the next variable as pseudo-parameters will enable formatting this workflow for any datasets
FASTQS_LOC=fastq_trimmed/surviv_pairs_fastqs # This will vary between "Basecalls", "Alignment_1", etc (as you can see here for example)
